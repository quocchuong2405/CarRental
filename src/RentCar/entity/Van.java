...
public class Van extends Vehicle {
	...
	public Van(int distance) {
		this.distance = distance;
	}
	
	public Van(int id, String carname, String brand, String color, int seat, int distance) {
		super();
		this.id = id;
	...
	public Van(int id, String carname, String brand, String color, int seat, int distance, Customer owner) {
		super();
		this.id = id;
		this.carname = carname;
		this.brand = brand;
	...
	public Van(int id, String carname, String brand, String color, int seat, int distance, int oil_change_times, 
